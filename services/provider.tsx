...
const crossfiTestnet: Chain = {
  ...
  blockExplorers: {
    default: { name: 'CrossFi testnet Block Explorer', url: 'https://test.xfiscan.com/' },
    etherscan: { name: 'CrossFi testnet Block Explorer', url: 'https://test.xfiscan.com/' },
  },
  testnet: true,
}

const { chains, publicClient } = configureChains(
  [mainnet, crossfiTestnet, hardhat],
